...
BLOCKS[0x8a:0x90] = [u'Arabic Extended-A'] * 0x6
...
BLOCKS[0xaae:0xab0] = [u'Meetei Mayek Extensions'] * 0x2
...
BLOCKS[0x1098:0x109a] = [u'Meroitic Hieroglyphs'] * 0x2
BLOCKS[0x109a:0x10a0] = [u'Meroitic Cursive'] * 0x6
...
BLOCKS[0x110d:0x1110] = [u'Sora Sompeng'] * 0x3
BLOCKS[0x1110:0x1115] = [u'Chakma'] * 0x5
BLOCKS[0x1118:0x111e] = [u'Sharada'] * 0x6
BLOCKS[0x1168:0x116d] = [u'Takri'] * 0x5
